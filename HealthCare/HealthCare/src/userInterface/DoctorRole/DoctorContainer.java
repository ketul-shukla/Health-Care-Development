...
public class DoctorContainer extends javax.swing.JPanel {
    ...
    private void populateScheduleTable()
    {
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            row[1] = request;
            row[2] = request.getRequestDate();
            String result = ((MedicineWorkRequest) request).getComments();
            row[3] = result == null ? "Waiting" : result;
    ...
    private void initComponents() {
        ...
        splitPaneDoctor.setDividerLocation(250);
        splitPaneDoctor.setDividerSize(1);

        DoctorContainerLeftPanel.setBackground(new java.awt.Color(104, 120, 128));

        btnCreateSchedule.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        btnModifySchedule.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        btnRequestLabTest.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        btnRequestMedicine.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        DoctorContainerLeftPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, DoctorContainerLeftPanelLayout.createSequentialGroup()
        ...
        tblLabRequests.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient Name", "Tests/Medicines", "Request Date", "Status"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false
